...
public class NetTool {
	...
	/**
	 * Find in a list a UnifiedPacket with certain index
	 * 
	 * @param index
	 *            index of that UnifiedPacket
	 * @param list
	 *            list in which to search
	 * @return a UnifiedPacket
	 */
	public static UnifiedPacket find(int index, Queue<UnifiedPacket> list) {
